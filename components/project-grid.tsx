...
function AboutMeGridItem() {
  return (
    <div className="group">
      <div className="aspect-[4/3] bg-secondary mb-4 relative overflow-hidden flex items-center justify-center">
        <div className="p-8 text-center">
          <h3 className="text-lg font-mono mb-4">ABOUT ME</h3>
          <p className="text-sm text-muted-foreground mb-6 font-light tracking-wide max-w-xs mx-auto">
