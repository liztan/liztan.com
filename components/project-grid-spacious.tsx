...
export function ProjectGridSpacious({ projects }: { projects: Project[] }) {
  return (
...
function ProjectGridItem({ project }: { project: Project }) {
  return (
    <div className="group border-r border-b border-border p-8 flex flex-col min-h-[500px]">
      ...
      <div className="flex-grow mb-8">{/* This space intentionally left empty to match the inspiration */}</div>
